...
with open('./model/saved_model_V2_ACC_77.7/train.pkl', 'rb') as pickle_file:
...
sequence_model = keras.models.load_model('./model/saved_model_V2_ACC_77.7')
...
def to_gif(images):
    ...
    imageio.mimsave("./output/animation.gif", converted_images, fps=10)
    
    # return embed.embed_file("animation.gif")
v = ["Good_Clips", "Bad_Clips"]

test_video = "./data/test/Good_Clips/CSGO_test2.mp4"
